    ...
    rules: {
      ...
      'prettier/prettier': [
        'error',
        {
          ...
          trailingComma: 'all',
          quoteProps: 'preserve',
          endOfLine: 'auto', // <--- FIX: Verhindert "Delete CR" Fehler auf Windows
        },
      ],
      ...
      'stylistic/no-mixed-operators': 'off', // <--- FIX: War "warn", jetzt aus. Behebt die Rechen-Fehler.
      ...
      // --- NEUE REGELN (HIERMIT VERSCHWINDEN DIE ROTEN LINIEN) ---
